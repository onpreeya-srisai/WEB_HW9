...
<?php
    ...
    if(mysqli_num_rows($result)>0){
        ...
        echo "<table border=1><tr><th>id</th><th>name</th><th>description</th><th>price</th><th>picture</th><th>ใส่สินค้า</th></tr>";
        while($row=mysqli_fetch_assoc($result)){
        echo "<tr><td>".$row["id"]."</td><td>".$row["name"]."</td><td>";
        echo $row["description"]."</td><td>".$row["price"]."</td><td>";
        echo "<img src='".$row["picture"]."' width=200></td><td>";
        echo "<a href='add_product.php?id=".$row["id"]."'>ใส่ตระกร้า</a></td>";
        }
        echo "</table>";
    }else{
        echo "0 results";
    ...
    echo "<a href='del_all_product.php'>";
    echo "<h4 style='text-align:right'>ลบรายการสินค้าทั้งหมดทั้งหมด</h4></a>";
    ...
    echo "<button>";
    echo "<a href='checkout.php'>บันทึกการทำรายการ</a>";
    echo "</button>";
    echo "</div>";
    }
